...
public class StationaryItemParticle extends TextureSheetParticle {
   StationaryItemParticle(ClientLevel pLevel, double pX, double pY, double pZ, ItemLike pItemLike) {
      super(pLevel, pX, pY, pZ);
      this.setSprite(Minecraft.getInstance().getItemRenderer().getItemModelShaper().getParticleIcon(pItemLike));
      this.gravity = 0.0F;
      this.lifetime = 80;
