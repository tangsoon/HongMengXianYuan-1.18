...
public class Gui extends GuiComponent {
   ...
   public void render(PoseStack pPoseStack, float pPartialTick) {
      ...
      if (this.minecraft.gameMode.getPlayerMode() == GameType.SPECTATOR) {
         this.spectatorGui.renderHotbar(pPoseStack, pPartialTick);
         ...
         for(MobEffectInstance mobeffectinstance : Ordering.natural().reverse().sortedCopy(collection)) {
            ...
            if (mobeffectinstance.showIcon()) {
               ...
               if (mobeffectinstance.isAmbient()) {
                  this.blit(pPoseStack, k, l, 165, 166, 24, 24);
               } else {
                  this.blit(pPoseStack, k, l, 141, 166, 24, 24);
               ...
               list.add(() -> {
                  ...
                  blit(pPoseStack, j1 + 3, k1 + 3, this.getBlitOffset(), 18, 18, textureatlassprite);
               });
               renderer.renderHUDEffect(mobeffectinstance,this, pPoseStack, k, l, this.getBlitOffset(), f);
            }
         }
