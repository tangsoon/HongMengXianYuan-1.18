...
/**
 * A transformer which modifies a single position based on the four cardinal adjacent positions.
 * The 'Castle' is a reference to the castle in chess moving in cardinal directions.
 */
