...
public class Item extends net.minecraftforge.registries.ForgeRegistryEntry<Item> implements ItemLike, net.minecraftforge.common.extensions.IForgeItem {
   ...
   public boolean isBarVisible(ItemStack pStack) {
      return pStack.getItem().showDurabilityBar(pStack);
   }

   public int getBarWidth(ItemStack pStack) {
      return Math.round(13.0F - ((float) pStack.getItem().getDurabilityForDisplay(pStack) * 13.0F));
   }

   public int getBarColor(ItemStack pStack) {
      return pStack.getItem().getRGBDurabilityForDisplay(pStack);
   }
