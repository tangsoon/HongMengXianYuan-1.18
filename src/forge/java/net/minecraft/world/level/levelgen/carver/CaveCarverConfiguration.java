...
public class CaveCarverConfiguration extends CarverConfiguration {
   ...
   public CaveCarverConfiguration(float pProbability, HeightProvider pY, FloatProvider pYScale, VerticalAnchor pLavaLevel, boolean pAquifersEnabled, CarverDebugSettings pDebugSettings, FloatProvider pHorizontalRadiusMultiplier, FloatProvider pVerticalRadiusMultiplier, FloatProvider pFloorLevel) {
      super(pProbability, pY, pYScale, pLavaLevel, pAquifersEnabled, pDebugSettings);
   ...
   public CaveCarverConfiguration(float pProbability, HeightProvider pY, FloatProvider pYScale, VerticalAnchor pLavaLevel, boolean pAquifersEnabled, FloatProvider pHorizontalRadiusMultiplier, FloatProvider pVerticalRadiusMultiplier, FloatProvider pFloorLevel) {
      this(pProbability, pY, pYScale, pLavaLevel, pAquifersEnabled, CarverDebugSettings.DEFAULT, pHorizontalRadiusMultiplier, pVerticalRadiusMultiplier, pFloorLevel);
   }
