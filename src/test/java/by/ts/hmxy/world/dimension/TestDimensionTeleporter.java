...
//				Sets.newHashSet(ImmutableSet.copyOf(HmxyModBlocks.TEST_DIMENSION_PORTAL.getStateDefinition().getPossibleStates())), 0, 1)
...
//			}
//		}
//		BlockState blockstate = HmxyModBlocks.TEST_DIMENSION_PORTAL.defaultBlockState().setValue(NetherPortalBlock.AXIS, p_77668_);
