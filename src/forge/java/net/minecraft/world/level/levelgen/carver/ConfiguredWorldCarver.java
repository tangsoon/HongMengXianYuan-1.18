...
public class ConfiguredWorldCarver<WC extends CarverConfiguration> {
   ...
   public boolean carve(CarvingContext pContext, ChunkAccess pChunk, Function<BlockPos, Biome> pBiomeAccessor, Random pRandom, Aquifer pAquifer, ChunkPos pChunkPos, BitSet pCarvingMask) {
      return this.worldCarver.carve(pContext, this.config, pChunk, pBiomeAccessor, pRandom, pAquifer, pChunkPos, pCarvingMask);
   }
}