...
public class Structures {
    ...
    public static final DeferredRegister<StructureFeature<?>> DEFERRED_REGISTRY_STRUCTURE = DeferredRegister.create(ForgeRegistries.STRUCTURE_FEATURES, HmxyMod.MOD_ID);
     ...
     */
    public static final RegistryObject<StructureFeature<NoneFeatureConfiguration>> RUN_DOWN_HOUSE = DEFERRED_REGISTRY_STRUCTURE.register("run_down_house", () -> (new RunDownHouseStructureFeature(NoneFeatureConfiguration.CODEC)));
