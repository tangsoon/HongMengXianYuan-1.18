...
public class TestBiomeLeaveDecorator extends LeaveVineDecorator {
	public static final TestBiomeLeaveDecorator INSTANCE = new TestBiomeLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("test_biome_tree_leave_decorator");
