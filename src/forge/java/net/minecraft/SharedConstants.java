...
public class SharedConstants {
   ...
   /**
    * Sets the game version, failing if a different game version is already present.
    * 
    * @throws IllegalStateException if a different game version has already been set previously
    * @param pVersion the game version to set
    */
   ...
   /**
    * {@return the {@link com.mojang.bridge.game.GameVersion game version}}
    * 
    * @throws IllegalStateException if a game version has not been set previously
    */
