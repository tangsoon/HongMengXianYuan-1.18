...
public class ShipwreckPieces {
   ...
   public static class ShipwreckPiece extends TemplateStructurePiece {
      ...
      public boolean postProcess(WorldGenLevel pLevel, StructureFeatureManager pStructureManager, ChunkGenerator pGenerator, Random pRandom, BoundingBox pBox, ChunkPos pChunkPos, BlockPos pPos) {
         ...
         return super.postProcess(pLevel, pStructureManager, pGenerator, pRandom, pBox, pChunkPos, pPos);
      }
   }
}