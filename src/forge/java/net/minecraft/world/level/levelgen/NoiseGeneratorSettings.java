...
public final class NoiseGeneratorSettings {
   ...
   public static NoiseGeneratorSettings register(ResourceKey<NoiseGeneratorSettings> pKey, NoiseGeneratorSettings pSettings) {
   ...
   public static NoiseGeneratorSettings endLikePreset(StructureSettings pStructureSettings, BlockState pDefaultBlock, BlockState pDefaultFluid, boolean pDisableMobGeneration, boolean pIslandNoiseOverride) {
   ...
   public static NoiseGeneratorSettings netherLikePreset(StructureSettings pStructureSettings, BlockState pDefaultBlock, BlockState pDefaultFluid) {
   ...
   public static NoiseGeneratorSettings overworld(StructureSettings pStructureSettings, boolean pIsAmplified) {
