...
public class OptimizeWorldScreen extends Screen {
   ...
   public static OptimizeWorldScreen create(Minecraft pMinecraft, BooleanConsumer pCallback, DataFixer pDataFixer, LevelStorageSource.LevelStorageAccess pLevelStorage, boolean pEraseCache) {
      ...
      try {
         ...
         try {
            ...
            optimizeworldscreen = new OptimizeWorldScreen(pCallback, pDataFixer, pLevelStorage, worlddata.getLevelSettings(), pEraseCache, immutableset);
   ...
   private OptimizeWorldScreen(BooleanConsumer pCallback, DataFixer pDataFixer, LevelStorageSource.LevelStorageAccess pLevelStorage, LevelSettings pLevelSettings, boolean pEraseCache, ImmutableSet<ResourceKey<Level>> pLevels) {
