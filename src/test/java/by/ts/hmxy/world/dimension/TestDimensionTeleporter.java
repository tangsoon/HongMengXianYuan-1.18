...
public class TestDimensionTeleporter implements ITeleporter {
	...
	public static void registerPointOfInterest(RegistryEvent.Register<PoiType> event) {
		poi = new PoiType("test_dimension_portal",
				Sets.newHashSet(ImmutableSet.copyOf(HmxyBlocksTest.TEST_DIMENSION_PORTAL.get().getStateDefinition().getPossibleStates())), 0, 1)
	...
	public Optional<BlockUtil.FoundRectangle> createPortal(BlockPos p_77667_, Direction.Axis p_77668_) {
		...
		BlockState blockstate = HmxyBlocksTest.TEST_DIMENSION_PORTAL.get().defaultBlockState().setValue(NetherPortalBlock.AXIS, p_77668_);
