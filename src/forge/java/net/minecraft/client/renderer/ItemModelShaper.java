...
public class ItemModelShaper {
   ...
   public TextureAtlasSprite getParticleIcon(ItemStack pStack) {
      ...
      return bakedmodel == this.modelManager.getMissingModel() && pStack.getItem() instanceof BlockItem ? this.modelManager.getBlockModelShaper().getParticleIcon(((BlockItem)pStack.getItem()).getBlock().defaultBlockState()) : bakedmodel.getOverrides().resolve(bakedmodel, pStack, null, null, 0).getParticleIcon(net.minecraftforge.client.model.data.EmptyModelData.INSTANCE);
   }
