...
public class RandomPatchConfiguration implements FeatureConfiguration {
   ...
   RandomPatchConfiguration(BlockStateProvider pStateProvider, BlockPlacer pBlockPlacer, Set<Block> pWhitelist, Set<BlockState> pBlacklist, int pTries, int pXspread, int pYspread, int pZspread, boolean pCanReplace, boolean pProject, boolean pNeedWater) {
   ...
   public static class GrassConfigurationBuilder {
      ...
      public GrassConfigurationBuilder(BlockStateProvider pStateProvider, BlockPlacer pBlockPlacer) {
         this.stateProvider = pStateProvider;
         this.blockPlacer = pBlockPlacer;
      }
