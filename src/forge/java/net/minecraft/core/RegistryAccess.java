...
public abstract class RegistryAccess {
   ...
   static final class RegistryData<E> {
      ...
      /**
       * 
       * @param pKey The registry key of this registry.
       * @param pCodec The codec used to serialize this registry's elements internally.
       * @param pNetworkCodec The codec used to serialize this registry's elements when sending them to the client. This
       * being null implies that the contents of this registry are not synchronized to client.
       */
      ...
      /**
       * @return The codec used to serialize this registry's elements when sending them to the client. Returns {@code
       * null} if this registry should not be synchronized with the client.
       */
      @Nullable
