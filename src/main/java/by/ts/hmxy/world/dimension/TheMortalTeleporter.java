...
//	public static final TicketType<BlockPos> CUSTOM_PORTAL = TicketType.create("the_mortal_portal", Vec3i::compareTo, 300);
	...
	public static void registerPointOfInterest(RegistryEvent.Register<PoiType> event) {
		poi = new PoiType("the_mortal_portal",
				Sets.newHashSet(ImmutableSet.copyOf(HmxyBlocks.THE_MORTAL_PORTAL.get().getStateDefinition().getPossibleStates())), 0, 1)
	...
	public TheMortalTeleporter(ServerLevel worldServer, BlockPos entityEnterPos) {
...
//			}
//		}
//		BlockState blockstate = HmxyBlocks.THE_MORTAL_PORTAL.get().defaultBlockState().setValue(NetherPortalBlock.AXIS, p_77668_);
...
//				entityNew.moveTo(entity.getX(), entity.getY(), entity.getZ(),entity.getYRot(), entity.getXRot());
...
//				vector3d = TheMortalPortalShape.getRelativePosition(teleportationrepositioner$result, direction$axis, entity.position(),
//						entity.getDimensions(entity.getPose()));
//			} else {
//				direction$axis = Direction.Axis.X;
//				vector3d = new Vec3(0.5, 0, 0);
//			}
//			return TheMortalPortalShape.createPortalInfo(server, repositioner, direction$axis, vector3d, entity.getDimensions(entity.getPose()),
