...
public class RealmsMainScreen extends RealmsScreen {
   ...
   public void render(PoseStack pPoseStack, int pMouseX, int pMouseY, float pPartialTick) {
      ...
      if (this.trialsAvailable && !this.createdTrial && this.shouldShowPopup()) {
         ...
         GuiComponent.blit(pPoseStack, this.createTrialButton.x + this.createTrialButton.getWidth() - 8 - 4, this.createTrialButton.y + this.createTrialButton.getHeight() / 2 - 4, 0.0F, (float)j, 8, 8, 8, 16);
      }
   ...
   class CloseButton extends Button {
      ...
      public void renderButton(PoseStack pPoseStack, int pMouseX, int pMouseY, float pPartialTick) {
         ...
         blit(pPoseStack, this.x, this.y, 0.0F, f, 12, 12, 12, 24);
   ...
   class NewsButton extends Button {
      ...
      public void renderButton(PoseStack pPoseStack, int pMouseX, int pMouseY, float pPartialTick) {
         RealmsMainScreen.this.renderNews(pPoseStack, pMouseX, pMouseY, RealmsMainScreen.this.hasUnreadNews, this.x, this.y, this.isHovered(), this.active);
      }
   }
   ...
   class PendingInvitesButton extends Button {
      ...
      public void renderButton(PoseStack pPoseStack, int pMouseX, int pMouseY, float pPartialTick) {
         RealmsMainScreen.this.drawInvitationPendingIcon(pPoseStack, pMouseX, pMouseY, this.x, this.y, this.isHovered(), this.active);
      }
   }
   ...
   class RealmSelectionList extends RealmsObjectSelectionList<RealmsMainScreen.Entry> {
      ...
      public void setSelected(@Nullable RealmsMainScreen.Entry pSelected) {
         super.setSelected(pSelected);
         int i = this.children().indexOf(pSelected) - (this.showingMessage ? 1 : 0);
   ...
   class ShowPopupButton extends Button {
      ...
      public void renderButton(PoseStack pPoseStack, int pMouseX, int pMouseY, float pPartialTick) {
         RealmsMainScreen.this.renderMoreInfo(pPoseStack, pMouseX, pMouseY, this.x, this.y, this.isHovered());
      }
   }
